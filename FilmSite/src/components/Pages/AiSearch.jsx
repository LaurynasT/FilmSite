...
const AiSearch = () => {
  ...
  const handleGetRecommendations = async (mediaType = activeTab) => {
    ...
    try {
      const data =
        await RecommendationService.getRecommendationsFromFavorites(mediaType);
  ...
  const handleTextRecommendations = async (e) => {
    ...
    try {
      const data = await RecommendationService.getRecommendationsFromText(
        textPrompt,
        mediaType,
      );
      setRecommendations(data.recommendations || []);
  ...
  return (
    <div className="recommendations-page container">
      <header>
        ...
        <p className="lead">
          Discover new content based on your favorites or specific requests
        </p>
      </header>
      ...
      <div className="recommendation-options">
        <div className="recommendation-method">
          ...
          <div className="recommendation-buttons">
            ...
            >
              {loading && lastRecommendationType === "favorites"
                ? "Loading..."
          ...
          {showTextInput && (
            <form
              onSubmit={handleTextRecommendations}
              className="text-recommendation-form"
            >
              <div className="input-group">
                ...
                <button
                  ...
                  disabled={loading}
                >
                  {loading && lastRecommendationType === "text"
                    ? "Loading..."
                    : "Get Custom Recommendations"}
                </button>
              </div>
              <p className="hint">
                Describe what you're in the mood for or specific themes you'd
                like to explore
              </p>
            </form>
          )}
        ...
        <div className="recommendations-section">
          ...
          {recommendations.length === 0 ? (
            <div className="empty-recommendations">
              <p>
                No recommendations yet. Get started by clicking one of the
                buttons above!
              </p>
              {favorites.length === 0 && (
                <p>
